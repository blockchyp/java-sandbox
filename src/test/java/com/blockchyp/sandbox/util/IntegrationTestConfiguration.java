package com.blockchyp.sandbox.util;
...
public class IntegrationTestConfiguration {
		...
		try {
			...
			if (!configFile.exists()) {
				throw new IllegalStateException(
						"Unable to locate test configuration file at " + configFile.getAbsolutePath());
			}
	...
	public static BlockChypClient getTestClient() {
		return new BlockChypClient(IntegrationTestConfiguration.getGatewayHost(),
				IntegrationTestConfiguration.getTestGatewayHost(), IntegrationTestConfiguration.getTestCredentials());
	}
